@extends('layouts.app')
  @section('content')
    ...
    <div class="col-sm-12" id="formulario">
      <div class="row">
        <div class="col-md-4">
          {!! Form::open(['route' => 'departamentos/search', 'method' => 'post', 'novalidate']) !!}
        ...
        <div class="col-md-4 col-md-offset-4">
          @can('departamentos.create')
            <a href="{{ route('departamentos.create') }}" class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Agregar</a>
          @endcan
        </div>
      </div>
      <table>
        ...
        <tbody>
          @foreach($departamentos as $Departamento)
            <tr>
              ...
              <td>{{$Departamento->nombrePai}}</td>
              @can('departamentos.edit')
                <td class="espacio2" width="10px">
                  <a href="{{ route('departamentos.edit', $Departamento->id) }}" class="btn" data-toggle="tooltip" data-placement="right" data-original-title="Editar"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                </td>
              @endcan
