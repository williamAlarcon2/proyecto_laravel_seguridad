@extends('layouts.app')
  @section('content')
    ...
    <div class="col-sm-8 col-md-offset-2" id="formulario">
      {{ Form::open(['route' => 'sistemaexplotaciones.store']) }}
        <div class="input-group separacion">
      		<span class="input-group-addon"><i class="fa fa-address-card-o fa-2x"></i></span>
      		<div class="form-group label-floating">
              <label class="control-label">Nombre</label>
              <input type="text" name="nombreSis" class="form-control" id="nombreSis" value="{{ old('nombreSis')}}">
          </div>
        </div>
        <div class="row">
        ...
        <div class="checkbox-detailed">
          <input type="checkbox" name="modulopSis" value="Ponedoras" id="check-det-1"/>
